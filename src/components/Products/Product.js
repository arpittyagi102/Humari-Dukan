...
export default function Product(props) {
  ...
  return (
    <div className={` m-4 border rounded-4 shadow-lg d-flex flex-column hover-shadow box product active`} ref={elementRef} style={{ width: "200px", overflow: "hidden" }} onClick={handleclick}>
