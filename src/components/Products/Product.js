...
export default function Product(props) {
  ...
  useEffect(() => {
    ...
    return (
            <div className={` m-4 border rounded-4 shadow-lg d-flex flex-column hover-shadow box prodct ${isVisible ? 'active' : ''} `} ref={elementRef} style={{ width: "200px", overflow: "hidden" }} onClick={handleclick}>
