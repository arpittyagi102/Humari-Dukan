...
export default function Productlarge() {
  ...
  return (
    <>
      <div className="cart-item container d-flex justify-content-center">
        <div
          className="cart-img bg-white align-items-center justify-content-center d-flex object-fit-contain m-5 rounded-4"
          style={{ width: "40%" }}
        >
          <img
        ...
        <div className="cart-content w-50">
