    ...
    return (
        <>
            <div className="container d-flex justify-content-center">
                <div className="bg-white w-40 align-items-center justify-content-center d-flex object-fit-contain m-5 rounded-4" >
                ...
                <div className="w-50">
                    ...
                    <h2 className="m-5 text-white mb-4" style={{ fontFamily: "Times New Roman", textShadow: '0 0 5px blue' }}>{state.title}</h2>
                    <h5 className="text-success ms-5" style={{ margin: "0px" }}>Special Price</h5>
                    <h2 className="mx-5 mt-1 d-flex text-white align-items-center">MRP:
                    ...
                    <h1 className="m-5">{state.description}</h1>
                    <h1 className="m-5">{state.category}</h1>
                </div>
            </div>
        </>
    )
